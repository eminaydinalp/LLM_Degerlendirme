...
`analyze_llm_evaluation_results.py` scripti, grup bazlı LLM değerlendirme sonuçlarını analiz eder, CSV tabloları ve performans grafikleri oluşturur.
...
python analyze_llm_evaluation_results.py --evaluator chatgpt_ratings --group 1

# DeepSeek sonuçlarını analiz et - Her seviye kendi klasöründe
python analyze_llm_evaluation_results.py --evaluator deepseek_ratings --group 1
```
...
python analyze_llm_evaluation_results.py --evaluator chatgpt_ratings --group 1 --combined
```
...
python analyze_llm_evaluation_results.py --evaluator chatgpt_ratings --levels A1 A2 --group 1

# B1 ve B2 seviyelerini, Grup 1 ve 2'yi analiz et
python analyze_llm_evaluation_results.py --evaluator deepseek_ratings --levels B1 B2 --group 1 2
```
...
python analyze_llm_evaluation_results.py --evaluator chatgpt_ratings --group 1 2 3
```
...
python analyze_llm_evaluation_results.py --evaluator chatgpt_ratings --group 1 --skip-plots
```
