...
FINETUNED_MODEL = "/media/muhammet/3f3fe6f9-0b61-46bd-a5b7-6cabd78bbc9a/home/user/text-generation-webui/user_data/models/llama1b-c1-unsloth-v2_merged"
EVAL_DATA = "/home/muhammet/Documents/Tez/LLM_Degerlendirme/notebooks/fine_tuning/formatted_data/C1/training_data_c1_list_format_eval.json"
...
def main():
    ...
    print(f"| Fine-tuned C1  | {finetuned_loss:8.2f}  | {finetuned_ppl:10.2f} | {loss_improvement:5.1f}%   |")
    print()
    print("=" * 60)
    print("✅ SUMMARY")
    print("=" * 60)
    ...
    print("   - Fine-tuning successfully adapted the model to C1 level tasks")
    print()
    
    # Save results
    output_file = "/home/muhammet/Documents/Tez/LLM_Degerlendirme/notebooks/fine_tuning/formatted_data/Notes/C1_baseline_comparison.txt"
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write("BASELINE VS FINE-TUNED MODEL COMPARISON - C1 LEVEL\n")
        f.write("=" * 60 + "\n\n")
        f.write("| Model          | Eval Loss | Perplexity | İyileşme |\n")
        f.write("|----------------|-----------|------------|----------|\n")
        f.write(f"| Baseline       | {baseline_loss:8.2f}  | {baseline_ppl:10.2f} | -        |\n")
        f.write(f"| Fine-tuned C1  | {finetuned_loss:8.2f}  | {finetuned_ppl:10.2f} | {loss_improvement:5.1f}%   |\n")
        f.write("\n")
