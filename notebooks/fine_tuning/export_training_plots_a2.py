"""
TensorBoard loglarından A2 training grafikleri oluştur
"""
...
if 'train/loss' in ea.Tags()['scalars']:
    ...
    plt.title('A2 Fine-Tuning: Training Loss Over Time', fontsize=14, fontweight='bold')
...
if 'eval/loss' in ea.Tags()['scalars']:
    ...
    plt.title('A2 Fine-Tuning: Evaluation Loss Over Time', fontsize=14, fontweight='bold')
    plt.grid(True, alpha=0.3)
...
if 'train/loss' in ea.Tags()['scalars'] and 'eval/loss' in ea.Tags()['scalars']:
    ...
    plt.title('A2 Fine-Tuning: Training vs Evaluation Loss', fontsize=14, fontweight='bold')
...
if 'train/learning_rate' in ea.Tags()['scalars']:
    ...
    plt.title('A2 Fine-Tuning: Learning Rate Schedule (Cosine)', fontsize=14, fontweight='bold')
    plt.grid(True, alpha=0.3)
...
if 'train/grad_norm' in ea.Tags()['scalars']:
    ...
    plt.title('A2 Fine-Tuning: Gradient Norm Over Time', fontsize=14, fontweight='bold')
